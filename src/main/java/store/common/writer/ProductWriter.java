...
public class ProductWriter {
    ...
    public static void writeProductsToFile(CurrentProducts currentProducts, String fileName) {
    ...
    private static void write(CurrentProducts currentProducts, BufferedWriter writer) throws IOException {
    ...
    private static void writeProduct(Product product, BufferedWriter writer) {
        try {
    ...
    private static String getPromotionText(Product product) {
