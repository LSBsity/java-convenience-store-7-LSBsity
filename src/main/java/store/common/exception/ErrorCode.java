...
public enum ErrorCode {
    ...
    USER_CONFIRM_INPUT_ERROR(StoreConst.USER_CONFIRM_INPUT_ERROR_MSG),
    STOCK_UNDERFLOW(StoreConst.STOCK_UNDERFLOW_MSG),
    FILE_CONTAINS_NEGATIVE_NUMBERS(StoreConst.FILE_CONTAINS_NEGATIVE_NUMBERS_MSG);
